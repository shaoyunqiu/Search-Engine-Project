...
public class ImageIndexer {
	...
	public void indexSpecialFile(String filename){
      ...
      if(map.get(title) == null) {
			...
			Field hrefField = new Field("hreftext", hreftext, Field.Store.YES, Field.Index.NO) ;
			//hrefField.setBoost(2.0f);
			Field keywordsField = new Field("keywords", keywords, Field.Store.YES, Field.Index.NO);
			...
			Field h1Field = new Field("h1", headtext.get(0), Field.Store.YES, Field.Index.NO) ;
			//h1Field.setBoost(14.0f);
			Field h2Field = new Field("h2", headtext.get(1), Field.Store.YES, Field.Index.NO) ;
			//h2Field.setBoost(12.0f);
			Field h3Field = new Field("h3", headtext.get(2), Field.Store.YES, Field.Index.NO) ;
			//h3Field.setBoost(10.0f);
			Field h4Field = new Field("h4", headtext.get(3), Field.Store.YES, Field.Index.NO) ;
			//h4Field.setBoost(8.0f);
			Field h5Field = new Field("h5", headtext.get(4), Field.Store.YES, Field.Index.NO) ;
			//h5Field.setBoost(6.0f);
			Field h6Field = new Field("h6", headtext.get(5), Field.Store.YES, Field.Index.NO) ;
			//h6Field.setBoost(4.0f);
			fileNum ++ ;
			int tmpLength = 0 ;
			tmpLength += (title.length()+content.length()) ;
			for(int i = 0 ; i < 6 ; i ++){
